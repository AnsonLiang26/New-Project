A react budget application that helps users plan their budgets and see where their money is going. The application allows users to add budgets and expense items as well as delete them.
